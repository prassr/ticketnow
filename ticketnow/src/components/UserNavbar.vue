...
<template>
    <div class="header">
        ...
        <div class='nav-links'>
	        <div class="nav-left">
                <router-link :to="{name:'user_movies'}">Movies </router-link>
                <router-link :to="{name:'explore_venue'}">Venue </router-link>
		<!-- <router-link :to="{name:'booking_handler'}">Bookings</router-link> -->
            </div>
            <div class="nav-right">
                ...
                <div class="menu" v-if="isMenuOpen">
                    <div>
                        <router-link :to="{name:'user_bookings'}" @click.prevent="isMenuOpen = false;">My Bookings</router-link>
                    </div>
                    <div>
                        <router-link :to="{name:'user_profile'}" @click.prevent="isMenuOpen = false;">Account Settings</router-link>
                    </div>
                    <div>
